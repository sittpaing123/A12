...
BOT_TOKEN = environ.get('BOT_TOKEN', "6251753429:AAFoXlBnhuJYpctF2MsI3VEWkf-I_XfgFc4")
...
auth_channel = environ.get('AUTH_CHANNEL','-1001254905376')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001556622059')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001254905376')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "TESTA12")
